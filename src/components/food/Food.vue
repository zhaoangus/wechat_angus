              ...
              <div class="rating-wrapper">
                <ul v-if="food.ratings && food.ratings.length">
                  ...
                  class="rating-item border-1px" :key="rating.index">
                    ...
                    <p class="text">
                      <span v-if="(selectType===0||selectType===2)&&rating.rateType===0" class="iconfont thumb-up">&#xe62e;</span>
                      <span v-if="(selectType===1||selectType===2)&&rating.rateType===1" class="iconfont thumb-down">&#xe607;</span>
